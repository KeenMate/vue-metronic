...
<<<<<<< HEAD
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <m-icon name="icon-share" color="green-sharp"></m-icon>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <m-icon name="icon-share" color="red-sunglo"></m-icon>
    ...
    <m-column :size="6">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <m-icon name="icon-edit" color="dark"></m-icon>
                ...
                <ul class="pager">
                    <li class="previous">
                        <a href="javascript:;" class="btn blue">
                            <m-icon name="fa fa-angle-left"></m-icon> Older </a>
                    </li>
                    <li class="next">
                    ...
                    <ul class="media-list">
                        <li class="media">
                            <a class="pull-left" href="javascript:;">
                                <img class="media-object" src="http://lorempixel.com/64/64" alt=""> </a>
            ...
            <div class="portlet-body">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3">
                        <a href="javascript:;" class="thumbnail">
                            <img src="http://lorempixel.com/100/180" alt="100/180" style="height: 180px; width: 100%; display: block;"> </a>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <a href="javascript:;" class="thumbnail">
                            <img src="http://lorempixel.com/100/180" alt="100/180" style="height: 180px; width: 100%; display: block;"> </a>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="thumbnail">
                            <img src="http://lorempixel.com/100/200" alt="" style="width: 100%; height: 200px;">
                            <div class="caption">
